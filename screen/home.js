...
import shoes from '../assets/consts/shoes'
      ...
      >
       <View style={{alignItems:'flex-end'}}>
           <View style={{width:30,
                        ...
                        backgroundColor:shoe.like ? 'rgba(245,42,42,0.2)': 'rgba(0,0,0,0.2)'}}>
               <MaterialIcons name='favorite' size={19} color={shoe.like? 'red':'black'}/>
           </View>
       </View>
    ...
    <View style={{backgroundColor:'white', paddingTop:10,  flex:1, paddingHorizontal:10,marginTop:20,}}>
      ...
      <View >
        <View style={{flexDirection: 'column', marginBottom:10}}>
            ...
            <Text style={{color:'orange', fontSize:23,  fontWeight:'bold'}}> shoes</Text>
        </View>
